 ...
 * 
 * Create Time : 2014-10-31 15:09:50
 * 
...
namespace MasterDuner.Cooperations.Csq.Channels.RegExpressions
{
    /// <summary>
    /// <para>
    /// 类型名称：<see cref="ResidenceExpression"/>
    /// </para>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public sealed class ResidenceExpression : ExpressionBase
    {
        #region Constructors

        /// <summary>
        /// 初始化一个<see cref="ResidenceExpression" />对象实例。
        /// </summary>
        /// <remarks>
        /// 不可从此类继承。
        /// </remarks>
        public ResidenceExpression()
        { }
        ...
        {
            get { return @"<div\sclass=\""list-three\swid-128\""\stitle=\""(?<Residence>[\u0000-\u0021\u0023-\u00FF\u0100-\uFFFF]*)\"">[\u0000-\u0021\u0023-\u00FF\u0100-\uFFFF]*</div>"; }
        }
        #endregion
    }
}
