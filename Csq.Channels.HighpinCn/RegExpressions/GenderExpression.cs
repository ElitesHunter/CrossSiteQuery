 ...
 * 
 * Create Time : 2014-10-31 14:49:11
 * 
...
namespace MasterDuner.Cooperations.Csq.Channels.RegExpressions
{
    /// <summary>
    /// <para>
    /// 类型名称：<see cref="GenderExpression"/>
    /// </para>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public sealed class GenderExpression : ExpressionBase
    {
        #region Constructors

        /// <summary>
        /// 初始化一个<see cref="GenderExpression" />对象实例。
        /// </summary>
        /// <remarks>
        /// 不可从此类继承。
        /// </remarks>
        ...
        {
            get { return @"<div\sclass=\""list-three\swid-62\"">(?<Gender>[男女])</div>"; }
        }
        #endregion
    }
}
