 ...
 * 
 * Create Time : 2014-10-31 14:21:08
 * 
...
namespace MasterDuner.Cooperations.Csq.Channels.RegExpressions
{
    /// <summary>
    /// <para>
    /// 类型名称：<see cref="CompanyNameExpression"/>
    /// </para>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public sealed class CompanyNameExpression : ExpressionBase
    {
        #region Constructors

        /// <summary>
        /// 初始化一个<see cref="CompanyNameExpression" />对象实例。
        /// </summary>
        /// <remarks>
        /// 不可从此类继承。
        /// </remarks>
        public CompanyNameExpression()
        { }
        ...
        {
            get { return @"<div\sclass=\""list-three\swid-223\spadding-l7\stxt-l\shl\""\stitle=""(?<CompanyName>[\u0000-\u0021\u0023-\u00FF\u0100-\uFFFF]*)\"">[\u0000-\u0021\u0023-\u00FF\u0100-\uFFFF]*</div>"; }
        }
        #endregion
    }
}
