 ...
 * 
 * Create Time : 2014-10-31 14:00:29
 * 
...
namespace MasterDuner.Cooperations.Csq.Channels.RegExpressions
{
    /// <summary>
    /// <para>
    /// 类型名称：<see cref="JobTitleAndUrlExpression"/>
    /// </para>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public sealed class JobTitleAndUrlExpression : ExpressionBase
    {
        #region Constructors

        /// <summary>
        /// 初始化一个<see cref="JobTitleAndUrlExpression" />对象实例。
        /// </summary>
        /// <remarks>
        /// 不可从此类继承。
        /// </remarks>
        public JobTitleAndUrlExpression()
        { }
        ...
        {
            get { return @"<div\sclass=\""list-three\swid-223\spadding-l7\stxt-l\shl-jt\""\stitle=\""(?<PositionName>[\u0000-\u0021\u0023-\u00FF\u0100-\uFFFF]*)\""><a\shref=\""(?<DetailsUrl>[/a-zA-Z0-9\?\&=;%-\.#_,]*)\""\starget=\""(_blank|_self)\"">"; }
        }
        #endregion
    }
}
