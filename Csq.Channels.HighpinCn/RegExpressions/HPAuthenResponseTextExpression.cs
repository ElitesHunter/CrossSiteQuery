 ...
 * 
 * Create Time : 2014-10-23 10:31:42
 * 
...
namespace MasterDuner.Cooperations.Csq.Channels.RegExpressions
{
    /// <summary>
    /// <para>
    /// 类型名称：<see cref="HPAuthenResponseTextExpression"/>
    /// </para>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public sealed class HPAuthenResponseTextExpression : ExpressionBase
    {
        #region Constructors

        /// <summary>
        /// 初始化一个<see cref="HPAuthenResponseTextExpression" />对象实例。
        /// </summary>
        /// <remarks>
        /// 不可从此类继承。
        /// </remarks>
        public HPAuthenResponseTextExpression()
        { }
