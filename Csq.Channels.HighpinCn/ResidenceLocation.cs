 ...
 * 
 * Create Time : 2014-10-27 15:14:40
 * 
...
namespace MasterDuner.Cooperations.Csq.Channels
{
    /// <summary>
    /// <para>
    /// 类型名称：<see cref="ResidenceLocation"/>
    /// </para>
    /// <para>
    ...
    [Serializable]
    [DataContract]
    public sealed class ResidenceLocation : IdBase
    {
        ...
        /// <summary>
        /// 初始化一个<see cref="ResidenceLocation" />对象实例。
        /// </summary>
        /// <remarks>
        /// 不可从此类继承。
        /// </remarks>
        public ResidenceLocation()
        { }
