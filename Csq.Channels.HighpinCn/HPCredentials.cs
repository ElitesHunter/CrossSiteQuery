 ...
 * 
 * Create Time : 2014-10-23 9:55:40
 * 
...
namespace MasterDuner.Cooperations.Csq.Channels
{
    ...
    [Serializable]
    [DataContract]
    public sealed class HPCredentials : SearchChannelCredentials
    {
        #region Constructors

        /// <summary>
        /// 初始化一个<see cref="HPCredentials" />对象实例。
        /// </summary>
        /// <remarks>
        /// 不可从此类继承。
        /// </remarks>
        public HPCredentials()
        { }
